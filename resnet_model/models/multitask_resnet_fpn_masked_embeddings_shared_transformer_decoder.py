...
# Multitask ResNet
class MultiTaskResNetFPNMaskedEmbeddingsSharedTransformerDecoder(nn.Module):
    def __init__(self, 
                 num_instruments, 
                 num_verbs, 
                 num_targets,
        ...
        super(MultiTaskResNetFPNMaskedEmbeddingsSharedTransformerDecoder, self).__init__()
