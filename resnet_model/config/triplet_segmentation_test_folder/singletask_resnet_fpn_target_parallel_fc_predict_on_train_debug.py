...
train_image_dir = join(dataset_path, 'train_debug/img_dir')
train_ann_dir = join(dataset_path, 'train_debug/ann_second_stage')

val_image_dir = join(dataset_path, 'train_debug/img_dir')
val_ann_dir = join(dataset_path, 'train_debug/ann_second_stage')

test_image_dir = join(dataset_path, 'train_debug/img_dir')
test_ann_dir = join(dataset_path, 'train_debug/ann_second_stage')
...
# load_from_checkpoint =  join(f'../resnet_model/work_dirs/singletask_resnet_fpn_target_parallel_fc_predict_on_train_debug', 'epoch_20.pth')
