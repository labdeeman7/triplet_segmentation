...
load_from_checkpoint =  '/nfs/home/talabi/repositories/triplet_segmentation/checkpoints/resnet_threetask_multitask/best_model_epoch_19.pth'
...
# Multitask weights. 
verb_multitask_weight = 1.0
target_multitask_weight = 2.0 
verbtarget_multitask_weight = 2.0  