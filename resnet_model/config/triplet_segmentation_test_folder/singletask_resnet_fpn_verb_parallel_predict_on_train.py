...
description =  'predicting verb prediction parrallel FC on train'
...
load_from_checkpoint =  join(f'../resnet_model/work_dirs/singletask_resnet_fpn_verb_parallel_fc', 'epoch_20.pth')
