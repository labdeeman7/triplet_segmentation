...
test_image_dir = join(dataset_path, 'test/img_dir')
test_ann_dir = join(dataset_path, 'test/ann_second_stage')
...
load_from_checkpoint = '../resnet_model/work_dirs/multitask_resnet_fpn/best_model.pth'
