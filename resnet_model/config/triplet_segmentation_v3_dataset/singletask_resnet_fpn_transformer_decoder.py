...
# Model name
model_name = 'SingleTaskResNetFPNTransformerDecoder'
task_name = 'verbtarget'
description =  f'resnet_fpn predicting {task_name}'
architecture = 'singletask'

description =  'SingleTaskResNetFPNTransformerDecoder predicting verbtarget'
