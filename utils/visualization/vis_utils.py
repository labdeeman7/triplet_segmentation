...
def plot_instance_from_json_contour(contours_list: list, 
    ...
    colors = TripletSegmentationVariables.instrument_colors
    ...
    for i, contour_xy in enumerate(contours_list):
        ...
        plt.text(x_pos, y_pos, f'{label_name}' , color=normalized_rgb_color, ha='center')
...
class VisFromLabelMeToImg:
    ...
    def create_and_save_img_from_a_single_label_me_dict(self,
        ...
        verb_names = [ann['verb'] for ann in ann_contours]
        target_names = [ann['target'] for ann in ann_contours]
